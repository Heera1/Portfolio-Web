...
import { stackArr } from "../src/arr";

const About: NextPage = () => {

  const renderStack = (stack: any) => {
    return stack.map((item: any, idx: number) => (
          <p key={idx} className="px-2 py-1 mx-1 bg-MainColor/20 rounded-md">{item}</p>
    ))
  }
    ...
    <div className="px-6">
      <div className="scroll-container">
        ...
        <div className="mt-8 lg:flex sm:block sm:mt-6">
          ...
          <div className="lg:px-8">
            <p className="mb-6">
              ...
              만들며 개발자라는 직업에 흥미를 느끼게 되었고, 본격적으로
              프론트엔드 개발자가 되기 위해 웹 개발 부트캠프를
              수료하게 되었습니다. 미디어디자인 전공 수업에서 학습했던
        ...
        <div id="stacks" className="mb-16">
          <span className="about-h2">Stacks</span>
          {stackArr.slice(0).map((stack, idx) => (
            <span key={idx} className="flex mt-1.5">
              {renderStack(stack.value)}
            </span>
          ))}
        </div>
        <div id="education" className="mb-36">
          <span className="about-h2">Education</span>
          <h3 className="about-h3">&#42; 코드스테이츠 부트캠프 수료</h3>
          <p>2022.06~2022.12</p>
          <p>Advanced software engineering bootcamp (40기)</p>
